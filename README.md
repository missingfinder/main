...
`Look Around` 앱은 **사용자가 이동하는 동안**, **백그라운드로 실행되어 주변에 신고된 실종자가 존재**하면 이를 **알려줍니다**. 이 알림을 받은 사용자는 **제공된 실종자 신상정보**를 토대로 **잠시 주변을 둘러보며 상황을 확인**할 수 있도록 설계되었습니다. 

만약 `LookAround`의 **이 아이디어에 공감**을 하신다면, 사용해보시고 **피드백** 주신다면 감사하겠습니다.
